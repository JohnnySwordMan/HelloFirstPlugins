package com.mars.activityhook1.util;

import android.content.Context;
import android.content.res.AssetManager;

import com.mars.activityhook1.HostApplication;
...
/**
 * Created by geyan.marx on 2020/10/10
 */
public class Utils {
    /**
    ...
    private static File getPluginBaseDir(String packageName) {
        if (sBaseDir == null) {
            sBaseDir = HostApplication.getContext().getFileStreamPath("plugin");
